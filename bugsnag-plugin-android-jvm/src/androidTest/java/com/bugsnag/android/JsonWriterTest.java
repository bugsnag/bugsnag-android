...
public final class JsonWriterTest {
    ...
    @Test
    public void testTopLevelValueTypes() throws IOException { // method monkey-patched
        ...
        writer1.endObject();
        writer1.close();
        assertEquals("{\"a\":true}", string1.toString());
        ...
        writer2.endObject();
        writer2.close();
        assertEquals("{\"a\":null}", string2.toString());
        ...
        writer3.endObject();
        writer3.close();
        assertEquals("{\"a\":123}", string3.toString());
        ...
        writer4.endObject();
        writer4.close();
        assertEquals("{\"a\":123.4}", string4.toString());
