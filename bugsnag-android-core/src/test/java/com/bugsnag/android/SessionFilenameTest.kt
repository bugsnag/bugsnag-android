...
class SessionFilenameTest {
    ...
    fun sessionFileName() {
        ...
        assertEquals("TEST APIKEY_my-uuid-uuuuuuuuuuuuuuuuuuuuuuuuuuuu_1504255147933_v2.json", fileName)
    }

    @Test
    fun getSessionApiKeyFromFileName() {
        val file = File("TEST APIKEY_my-uuid-uuuuuuuuuuuuuuuuuuuuuuuuuuuu_1504255147933_v2.json")
