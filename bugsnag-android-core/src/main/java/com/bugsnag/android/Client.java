...
import com.bugsnag.android.internal.ContextualPerformanceInstrumentation;
...
public class Client implements MetadataAware, CallbackAware, UserAware, FeatureFlagAware {
    ...
    public Client(@NonNull Context androidContext, @NonNull final Configuration configuration) {
        ...
        PerformanceInstrumentation<Object> performance =
                (PerformanceInstrumentation<Object>) configuration.getPerformanceInstrumentation();
        if (performance == null) {
            performance = NoPerformanceInstrumentation.INSTANCE;
        }

        final ContextualPerformanceInstrumentation<Object> startup =
                new ContextualPerformanceInstrumentation<>(
                        performance.onStart("Client Startup Wrapper", null),
                        performance
                );

        @SuppressWarnings("checkstyle:VariableDeclarationUsageDistance")
        Object constructorToken = startup.onStart("<init>");
        ...
        @SuppressWarnings("checkstyle:VariableDeclarationUsageDistance")
        Object configurationToken = startup.onStart("sanitiseConfiguration", constructorToken);
        ...
        TrackerModule trackerModule = new TrackerModule(configModule,
                storageModule, this, bgTaskService, callbackState, startup);
        ...
        DataCollectionModule dataCollectionModule = new DataCollectionModule(contextModule,
                ...
                memoryTrimState, clientObservable, startup);
        ...
        start(startup);
        startup.onEnd(constructorToken);
    }
    ...
    private void start(ContextualPerformanceInstrumentation<Object> startup) {
        ...
        pluginClient.loadPlugins(Client.this, startup);
        ...
        eventStore.get().flushOnLaunch(lastRunInfo, startup);
