...
internal fun convertToImmutableConfig(
    ...
    return ImmutableConfig(
        ...
        discardClasses = config.discardClasses.toHashSet(),
        enabledReleaseStages = config.enabledReleaseStages?.toHashSet(),
        projectPackages = config.projectPackages.toHashSet(),
        ...
        enabledBreadcrumbTypes = config.enabledBreadcrumbTypes?.toHashSet(),
