...
internal class LoadConfigurationKotlinScenario(
    ...
    override fun run() {
        super.run()
        var testConfig = Configuration("32132132132132132132132132132132")
        // testConfig.apiKey = "12312312312312312312312312312312"
        ...
        testConfig.projectPackages = arrayOf("com.company.package1", "com.company.package2")
        testConfig.discardClasses = arrayOf("java.net.UnknownHostException", "com.example.Custom")
        ...
        // testConfig.sendThreads = Thread.ThreadSendPolicy.ALWAYS
