...
void bsg_serialize_app(const bsg_app_info app, JSON_Object *event_obj) {
  ...
  json_object_dotset_integer(event_obj, "app.versionCode", app.version_code);
  ...
  json_object_dotset_integer(event_obj, "app.duration", app.duration);
  json_object_dotset_integer(event_obj, "app.durationInForeground",
...
void bsg_serialize_device(const bsg_device_info device,
  ...
  json_object_dotset_integer(event_obj, "device.totalMemory",
                             device.total_memory);
...
void bsg_serialize_stackframe(bugsnag_stackframe *stackframe, bool is_pc,
  ...
  json_object_set_integer(frame, "frameAddress", (*stackframe).frame_address);
  json_object_set_integer(frame, "symbolAddress", (*stackframe).symbol_address);
  json_object_set_integer(frame, "loadAddress", (*stackframe).load_address);
  json_object_set_integer(frame, "lineNumber", (*stackframe).line_number);
  if (is_pc) {
