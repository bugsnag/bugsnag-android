...
void bugsnag_event_add_metadata_double(void *event_ptr, const char *section,
  ...
  bsg_ctj_set_metadata_double(section, name, value);
  bugsnag_event *event = (bugsnag_event *)event_ptr;
  bsg_cache_set_metadata_double(&event->metadata, section, name, value);
}

void bugsnag_event_add_metadata_string(void *event_ptr, const char *section,
                                       const char *name, const char *value) {
  bsg_ctj_set_metadata_string(section, name, value);
  bugsnag_event *event = (bugsnag_event *)event_ptr;
  bsg_cache_set_metadata_string(&event->metadata, section, name, value);
}

void bugsnag_event_add_metadata_bool(void *event_ptr, const char *section,
                                     const char *name, bool value) {
  bsg_ctj_set_metadata_bool(section, name, value);
  bugsnag_event *event = (bugsnag_event *)event_ptr;
  bsg_cache_set_metadata_bool(&event->metadata, section, name, value);
}
...
char *bugsnag_event_get_context(void *event_ptr) {
  return bsg_cache_get_event_context(event_ptr);
}

void bugsnag_event_set_context(void *event_ptr, const char *value) {
  bsg_ctj_set_event_context(value);
  bsg_cache_set_event_context(event_ptr, value);
}
...
char *bugsnag_app_get_binary_arch(void *event_ptr) {
  return bsg_cache_get_app_binary_arch(event_ptr);
}

void bugsnag_app_set_binary_arch(void *event_ptr, const char *value) {
  bsg_ctj_set_app_binary_arch(value);
  bsg_cache_set_app_binary_arch(event_ptr, value);
}

char *bugsnag_app_get_build_uuid(void *event_ptr) {
  return bsg_cache_get_app_build_uuid(event_ptr);
}

void bugsnag_app_set_build_uuid(void *event_ptr, const char *value) {
  bsg_ctj_set_app_build_uuid(value);
  bsg_cache_set_app_build_uuid(event_ptr, value);
}
...
bool bugsnag_device_get_jailbroken(void *event_ptr) {
  return bsg_cache_get_device_jailbroken(event_ptr);
}

void bugsnag_device_set_jailbroken(void *event_ptr, bool value) {
  bsg_ctj_set_device_jailbroken(value);
  bsg_cache_set_device_jailbroken(event_ptr, value);
}
...
char *bugsnag_device_get_locale(void *event_ptr) {
  return bsg_cache_get_device_locale(event_ptr);
}

void bugsnag_device_set_locale(void *event_ptr, const char *value) {
  bsg_ctj_set_device_locale(value);
  bsg_cache_set_device_locale(event_ptr, value);
}

char *bugsnag_device_get_manufacturer(void *event_ptr) {
  return bsg_cache_get_device_manufacturer(event_ptr);
}

void bugsnag_device_set_manufacturer(void *event_ptr, const char *value) {
  bsg_ctj_set_device_manufacturer(value);
  bsg_cache_set_device_manufacturer(event_ptr, value);
}
...
char *bugsnag_device_get_os_version(void *event_ptr) {
  return bsg_cache_get_device_os_version(event_ptr);
}

void bugsnag_device_set_os_version(void *event_ptr, const char *value) {
  bsg_ctj_set_device_os_version(value);
  bsg_cache_set_device_os_version(event_ptr, value);
}

long bugsnag_device_get_total_memory(void *event_ptr) {
  return bsg_cache_get_device_total_memory(event_ptr);
}

void bugsnag_device_set_total_memory(void *event_ptr, long value) {
  bsg_ctj_set_device_total_memory(value);
  bsg_cache_set_device_total_memory(event_ptr, value);
}

char *bugsnag_device_get_orientation(void *event_ptr) {
  return bsg_cache_get_device_orientation(event_ptr);
}

void bugsnag_device_set_orientation(void *event_ptr, const char *value) {
  bsg_ctj_set_device_orientation(value);
  bsg_cache_set_device_orientation(event_ptr, value);
}
...
char *bugsnag_device_get_os_name(void *event_ptr) {
  return bsg_cache_get_device_os_name(event_ptr);
}

void bugsnag_device_set_os_name(void *event_ptr, const char *value) {
  bsg_ctj_set_device_os_name(value);
  bsg_cache_set_device_os_name(event_ptr, value);
}
...
bugsnag_user bugsnag_event_get_user(void *event_ptr) {
  return bsg_cache_get_event_user(event_ptr);
}

char *bugsnag_event_get_grouping_hash(void *event_ptr) {
  return bsg_cache_get_event_grouping_hash(event_ptr);
}

void bugsnag_event_set_grouping_hash(void *event_ptr, const char *value) {
  bsg_ctj_set_event_grouping_hash(value);
  bsg_cache_set_event_grouping_hash(event_ptr, value);
}
