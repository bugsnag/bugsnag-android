...
bool bsg_ctj_set_context(const char *context) {
  // {
  //   "events": [
  //     {
...
bool bsg_ctj_set_user(const char *id, const char *email, const char *name) {
  // {
  //   "events": [
  //     {
  //       "user": {
...
bool bsg_ctj_set_binary_arch(const char *arch) {
  // {
  //   "events": [
  //     {
  //       "app": {
...
bool bsg_ctj_set_build_uuid(const char *uuid) {
  // {
  //   "events": [
  //     {
  //       "app": {
...
bool bsg_ctj_set_jailbroken(bool value) {
  // {
  //   "events": [
  //     {
  //       "device": {
...
bool bsg_ctj_set_locale(const char *value) {
  // {
  //   "events": [
  //     {
  //       "device": {
...
bool bsg_ctj_set_manufacturer(const char *value) {
  // {
  //   "events": [
  //     {
  //       "device": {
...
bool bsg_ctj_set_os_version(const char *value) {
  // {
  //   "events": [
  //     {
  //       "device": {
...
bool bsg_ctj_set_total_memory(long value) {
  // {
  //   "events": [
  //     {
  //       "device": {
...
bool bsg_ctj_set_orientation(const char *value) {
  // {
  //   "events": [
  //     {
  //       "device": {
...
bool bsg_ctj_set_os_name(const char *value) {
  // {
  //   "events": [
  //     {
  //       "device": {
...
bool bsg_ctj_set_grouping_hash(const char *value) {
  // {
  //   "events": [
  //     {
...
bool bsg_ctj_add_metadata_double(const char *section, const char *name,
                                 double value) {
  // {
  //   "events": [
  //     {
...
bool bsg_ctj_add_metadata_string(const char *section, const char *name,
                                 const char *value) {
  // {
  //   "events": [
  //     {
...
bool bsg_ctj_add_metadata_bool(const char *section, const char *name,
                               bool value) {
  // {
  //   "events": [
  //     {
