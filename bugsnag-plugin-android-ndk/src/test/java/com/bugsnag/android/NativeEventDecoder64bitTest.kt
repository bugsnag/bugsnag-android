...
class NativeEventDecoder64bitTest {
    ...
    private fun verifyErrorDecode() {
        ...
        verify(stackFrame).file = "/data/app/~~dpOrZdWcDXB7AvWSQq_ToA==/com.example.bugsnag.android-qrHfhc0chd9kQAkU0AxRKQ==/lib/arm64/libentrypoint.so"
        verify(stackFrame).method = "Java_com_example_bugsnag_android_BaseCrashyActivity_crashFromCXX"
