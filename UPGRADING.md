...
| `Event` | This class should now be used to alter the details of an error report. This class is no longer publicly accessible as end-users should not need to set its values. |
