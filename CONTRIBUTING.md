...
If you have spotted a problem with this module, feel free to open a [new issue](https://github.com/bugsnag/bugsnag-android/issues/new?template=Bug_report.md). Here are a few things to check before doing so:
