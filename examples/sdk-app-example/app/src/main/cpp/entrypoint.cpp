...
JNIEXPORT void JNICALL Java_com_example_bugsnag_android_ExampleActivity_doCrash(JNIEnv *env, jobject instance) {
    crash_write_read_only();
}

JNIEXPORT void JNICALL Java_com_example_bugsnag_android_ExampleActivity_notifyFromCXX(JNIEnv *env, jobject instance) {
